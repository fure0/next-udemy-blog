...
export default function EditPostForm({post}: EditPostFormProps) {
  ...
  const [published, setPubluished] = useState(post.published)
  ...
  return (
    <div className="container mx-auto mt-10">
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div>
          <Label htmlFor="topImage" className="mb-1">トップ画像</Label>
          <Input
            type="file"
            id="topImage"
            accept="image/*"
        ...
        <div>
          <Label htmlFor="content" className="mb-1">内容(markdown)</Label>
          <TextareaAutosize
            id="content" name="content" className="w-full border p-2" placeholder="Markdonw形式で入力してください。"
            maxRows={8} value={content} onChange={handleContentChange}
          />
        ...
        <RadioGroup value={published.toString()} name="published" onValueChange={(value)=> setPubluished(value === 'true')}>
